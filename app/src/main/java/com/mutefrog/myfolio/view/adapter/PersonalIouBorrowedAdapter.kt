...
class PersonalIouBorrowedAdapter(private val arrayList: ArrayList<IOU>) :
    RecyclerView.Adapter<PersonalIouBorrowedAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val nameTextView: AppCompatTextView =
            itemView.findViewById(R.id.txt_personal_iou_borrowed_item_iou_name)
        val shareNowTagTextView: AppCompatTextView =
            itemView.findViewById(R.id.txt_personal_iou_borrowed_item_share_now_tag)
        val lenderNameTextView: AppCompatTextView =
            itemView.findViewById(R.id.txt_personal_iou_borrowed_item_lender_name)
        val borrowedAmountTextView: AppCompatTextView =
            itemView.findViewById(R.id.txt_personal_iou_borrowed_item_borrowed_amount)
        val deadlineTextView: AppCompatTextView =
            itemView.findViewById(R.id.txt_personal_iou_borrowed_item_deadline)
        val commentTextView: AppCompatTextView =
            itemView.findViewById(R.id.txt_comment)
        val menuImageView: AppCompatImageView =
            itemView.findViewById(R.id.iv_personal_iou_borrowed_item_menu)
    }

    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {

        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.view_personal_iou_borrowed_list_row, viewGroup, false)
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.lenderNameTextView.text = arrayList[position].getLenderNameValue()
        viewHolder.borrowedAmountTextView.text = arrayList[position].getTotalAmountValue()
