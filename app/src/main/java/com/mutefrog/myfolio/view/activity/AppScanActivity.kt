...
import com.mutefrog.myfolio.view.adapter.ImageAdapter
import com.mutefrog.myfolio.view.adapter.ImageAdapterListener
import com.mutefrog.myfolio.view.adapter.setImageFile
...
class AppScanActivity: ScanActivity(), ImageAdapterListener {
    ...
    lateinit var previewPhotoImageView: PhotoView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        previousButton = findViewById<ImageView>(R.id.previousButton)
        nextButton = findViewById<ImageView>(R.id.nextButton)
        previewPhotoImageView = findViewById<PhotoView>(R.id.previewPhotoImageView)
        doneButton = findViewById<Button>(R.id.btn_scan_done)
